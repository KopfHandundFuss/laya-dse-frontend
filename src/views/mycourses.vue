      ...
      <div class="row">
        <div class="col">
          ...
          <div class="d-flex justify-content-between">
            <h2 id="tab-focus" tabindex="0"><b>{{ i18n.title }}</b></h2>
          </div>
          <div class="sep"></div>
          <div id="filters" class="d-flex justify-content-start flex-wrap">
            <a href
               ...
               class="filter" :class="{active: cat.on}">
              <u>{{ cat.label }}</u>
            </a>
          </div>
          <div class="sep"></div>
            ...
            <ly-accordion :data="search(sort(filter(courses)))">
              ...
              <div slot="item" slot-scope="data">
                <div class="d-flex">
                  ...
                  <!-- course link -->
                  <!-- <a :href="'#/courses/'+data.item.name" class="w-50"> -->
                  <a href="#/dse" class="w-50">
                    <h4 class="m-0">
                      <u><strong>{{ data.item.name }}</strong></u>
                    </h4>
...
export default {
  ...
  created () {
    ...
    /*
     * fetch courses */
    http.get(`accounts/${ctx.auth.userId}/mycourses?filter[include]=author`)
      .then(function ({data}) {
        ctx.courses = data
        /*
