    ...
    <div class="container">
      <div class="row">
        ...
        <form class="w-100" style="margin-top: 1rem">
          ...
          <!-- Old Password -->
          <div class="form-group row">
            <label for="oldPwd" class="col-sm-3 col-form-label">
              {{ msg.oldPwd }}
            </label>
            <div class="col-sm-9">
              <input id="oldPwd"
          ...
          <!-- New Password -->
          <div class="form-group row">
            <label for="newPwd" class="col-sm-3 col-form-label">
              {{ msg.newPwd }}
            </label>
            <div class="col-sm-9">
              <input id="newPwd"
              ...
              <strong id="pwdMsg" class="form-text text-center">
                {{ pwdMsg }}
              </strong>
            </div>
          </div>
          ...
          <div class="form-group">
            <button type="submit" @click="submit" :disabled="busy"
                    class="btn btn-block btn-lg btn-outline-dark"
                    style="border-width: 2px">
              <i class="fas fa-check"></i> {{ msg.submit }}
            </button>
          </div>
...
<script>
import lyInputImg from '@comps/input-img'
...
export default {
  ...
  methods: {
    submit: function () {
      ...
      /* fire requests */
      http.all(requests)
        .then(http.spread(() => { ctx.formMsg = ctx.msg.submitOk }))
        .catch(function (err) {
          console.log(err)
